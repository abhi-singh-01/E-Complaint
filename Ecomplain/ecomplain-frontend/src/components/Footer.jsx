        ...
        <Grid container spacing={8} sx={{ justifyContent: 'space-between' }}>
          ...
          <Grid item xs={12} sm={4} md={3.5}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                <LocationOn sx={{ color: '#1976d2', fontSize: 24, mt: 0.5 }} />
                <Typography variant="body2" sx={{ color: '#b0b0b0', fontSize: '1.1rem', lineHeight: 1.5 }}>
                  Delhi-NCR<br />
                  Ghaziabad<br />
          ...
          <Grid item xs={12} sm={4} md={3.5}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              <Typography variant="body2" sx={{ color: '#b0b0b0', fontSize: '1.1rem', py: 0.5 }}>
